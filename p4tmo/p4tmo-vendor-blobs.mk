...
PRODUCT_COPY_FILES := \
    vendor/samsung/p4tmo/proprietary/lib/libcamera.so:obj/lib/libcamera.so \
    vendor/samsung/p4tmo/proprietary/lib/libaudio.so:obj/lib/libaudio.so \
    vendor/samsung/p4tmo/proprietary/lib/libaudiopolicy.so:obj/lib/libaudiopolicy.so \
    vendor/samsung/p4tmo/proprietary/lib/libseccameraadaptor.so:obj/lib/libseccameraadaptor.so

PRODUCT_COPY_FILES += \
    vendor/samsung/p4tmo/proprietary/bin/gpsd:system/bin/gpsd \
    vendor/samsung/p4tmo/proprietary/bin/nvrm_daemon:system/bin/nvrm_daemon \
    ...
    vendor/samsung/p4tmo/proprietary/etc/firmware/nvddk_audiofx_core.axf:system/etc/firmware/nvddk_audiofx_core.axf \
    vendor/samsung/p4tmo/proprietary/etc/firmware/nvddk_audiofx_transport.axf:system/etc/firmware/nvddk_audiofx_transport.axf \
    ...
    vendor/samsung/p4tmo/proprietary/etc/firmware/nvmm_audiomixer.axf:system/etc/firmware/nvmm_audiomixer.axf \
    vendor/samsung/p4tmo/proprietary/etc/firmware/nvmm_h264dec2x.axf:system/etc/firmware/nvmm_h264dec2x.axf \
    ...
    vendor/samsung/p4tmo/proprietary/etc/firmware/nvmm_mp2dec.axf:system/etc/firmware/nvmm_mp2dec.axf \
    vendor/samsung/p4tmo/proprietary/etc/firmware/nvmm_mp3dec.axf:system/etc/firmware/nvmm_mp3dec.axf \
    vendor/samsung/p4tmo/proprietary/etc/firmware/nvmm_mpeg2dec.axf:system/etc/firmware/nvmm_mpeg2dec.axf \
    vendor/samsung/p4tmo/proprietary/etc/firmware/nvmm_mpeg4dec.axf:system/etc/firmware/nvmm_mpeg4dec.axf \
    vendor/samsung/p4tmo/proprietary/etc/firmware/nvmm_reference.axf:system/etc/firmware/nvmm_reference.axf \
    vendor/samsung/p4tmo/proprietary/etc/firmware/nvmm_service.axf:system/etc/firmware/nvmm_service.axf \
    vendor/samsung/p4tmo/proprietary/etc/firmware/nvmm_sorensondec.axf:system/etc/firmware/nvmm_sorensondec.axf \
    vendor/samsung/p4tmo/proprietary/etc/firmware/nvmm_vc1dec_2x.axf:system/etc/firmware/nvmm_vc1dec_2x.axf \
    ...
    vendor/samsung/p4tmo/proprietary/etc/wifi/bcm4330_aps.bin:system/etc/wifi/bcm4330_aps.bin \
    vendor/samsung/p4tmo/proprietary/etc/wifi/bcm4330_mfg.bin:system/etc/wifi/bcm4330_mfg.bin \
    vendor/samsung/p4tmo/proprietary/etc/wifi/bcm4330_sta.bin:system/etc/wifi/bcm4330_sta.bin \
    vendor/samsung/p4tmo/proprietary/etc/wifi/bcm4330_sta.bin_b0:system/etc/wifi/bcm4330_sta.bin_b0 \
    vendor/samsung/p4tmo/proprietary/etc/wifi/nvram_mfg.txt:system/etc/wifi/nvram_mfg.txt \
    vendor/samsung/p4tmo/proprietary/etc/wifi/nvram_net.txt:system/etc/wifi/nvram_net.txt \
    vendor/samsung/p4tmo/proprietary/etc/wifi/nvram_net.txt_b0:system/etc/wifi/nvram_net.txt_b0 \
    vendor/samsung/p4tmo/proprietary/etc/wifi/nvram_net.txt_us:system/etc/wifi/nvram_net.txt_us \
    vendor/samsung/p4tmo/proprietary/etc/wifi/wl:system/etc/wifi/wl \
    vendor/samsung/p4tmo/proprietary/etc/wifi/wpa_supplicant.conf:system/etc/wifi/wpa_supplicant.conf \
    ...
    vendor/samsung/p4tmo/proprietary/lib/hw/overlay.tegra.so:system/lib/hw/overlay.tegra.so \
    vendor/samsung/p4tmo/proprietary/lib/hw/sensors.p3.so:system/lib/hw/sensors.p3.so \
    vendor/samsung/p4tmo/proprietary/lib/liba2dp.so:system/lib/liba2dp.so \
    vendor/samsung/p4tmo/proprietary/lib/libakm.so:system/lib/libakm.so \
    vendor/samsung/p4tmo/proprietary/lib/libarccamera.so:system/lib/libarccamera.so \
    vendor/samsung/p4tmo/proprietary/lib/libardrv_dynamic.so:system/lib/libardrv_dynamic.so \
    vendor/samsung/p4tmo/proprietary/lib/libaudiopolicy.so:system/lib/libaudiopolicy.so \
    vendor/samsung/p4tmo/proprietary/lib/libaudio.so:system/lib/libaudio.so \
    vendor/samsung/p4tmo/proprietary/lib/libcamera.so:system/lib/libcamera.so \
    ...
    vendor/samsung/p4tmo/proprietary/lib/libnvddk_aes_user.so:system/lib/libnvddk_aes_user.so \
    vendor/samsung/p4tmo/proprietary/lib/libnvddk_audiofx.so:system/lib/libnvddk_audiofx.so \
    vendor/samsung/p4tmo/proprietary/lib/libnvddk_vmr.so:system/lib/libnvddk_vmr.so \
    vendor/samsung/p4tmo/proprietary/lib/libnvdispatch_helper.so:system/lib/libnvdispatch_helper.so \
    vendor/samsung/p4tmo/proprietary/lib/libnvdispmgr_d.so:system/lib/libnvdispmgr_d.so \
    vendor/samsung/p4tmo/proprietary/lib/libnvec.so:system/lib/libnvec.so \
    vendor/samsung/p4tmo/proprietary/lib/libnvhdmi3dplay_jni.so:system/lib/libnvhdmi3dplay_jni.so \
    ...
    vendor/samsung/p4tmo/proprietary/lib/libnvmmlite_image.so:system/lib/libnvmmlite_image.so \
    vendor/samsung/p4tmo/proprietary/lib/libnvmmlite_msaudio.so:system/lib/libnvmmlite_msaudio.so \
    ...
    vendor/samsung/p4tmo/proprietary/lib/libnvmm_misc.so:system/lib/libnvmm_misc.so \
    ...
    vendor/samsung/p4tmo/proprietary/lib/libnvmm_tracklist.so:system/lib/libnvmm_tracklist.so \
    ...
    vendor/samsung/p4tmo/proprietary/lib/libnvmm_videorenderer.so:system/lib/libnvmm_videorenderer.so \
    vendor/samsung/p4tmo/proprietary/lib/libnvmm_video.so:system/lib/libnvmm_video.so \
    vendor/samsung/p4tmo/proprietary/lib/libnvmm_vp6_video.so:system/lib/libnvmm_vp6_video.so \
    ...
    vendor/samsung/p4tmo/proprietary/lib/libnvrm_channel.so:system/lib/libnvrm_channel.so \
    ...
    vendor/samsung/p4tmo/proprietary/lib/libnvstereoutils_jni.so:system/lib/libnvstereoutils_jni.so \
    vendor/samsung/p4tmo/proprietary/lib/libnvsystemuiext_jni.so:system/lib/libnvsystemuiext_jni.so \
    ...
    vendor/samsung/p4tmo/proprietary/lib/libPanoraMax3.so:system/lib/libPanoraMax3.so \
    ...
    vendor/samsung/p4tmo/proprietary/lib/libseccameraadaptor.so:system/lib/libseccameraadaptor.so \
    vendor/samsung/p4tmo/proprietary/lib/libseccamera.so:system/lib/libseccamera.so \
    vendor/samsung/p4tmo/proprietary/lib/libsecjpegencoder.so:system/lib/libsecjpegencoder.so \
