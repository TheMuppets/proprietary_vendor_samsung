...
PRODUCT_COPY_FILES += \
    ...
    vendor/samsung/venturi/proprietary/gralloc.aries.so:system/vendor/lib/hw/gralloc.aries.so \
    ...
    vendor/samsung/venturi/proprietary/lights.aries.so:system/lib/hw/lights.aries.so \
    ...
    vendor/samsung/venturi/proprietary/gps.aries.so:system/vendor/lib/hw/gps.aries.so \
    vendor/samsung/venturi/proprietary/gps.xml:system/vendor/etc/gps.xml \
    vendor/samsung/venturi/proprietary/sensors.aries.so:system/lib/hw/sensors.aries.so \
