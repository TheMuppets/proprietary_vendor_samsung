...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/proprietary/system/etc/wifi/nvram_mfg.txt_semcove:system/etc/wifi/nvram_mfg.txt_semcove \
    ...
    $(LOCAL_PATH)/proprietary/system/etc/wifi/nvram_net.txt_semcove:system/etc/wifi/nvram_net.txt_semcove
